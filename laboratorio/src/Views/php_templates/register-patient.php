        ...
        <div class="col-md-6 justify-content-center">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= BASE_URL . (isset($patient) ? 'patients/update' : 'patients') ?>" class="text-start" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="surnames" id="surnames"
                                   ...
                                   <?php if (isset($patient)): ?>
                                       value="<?= htmlspecialchars($patient->getSurnames()) ?>"
                                   <?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="family_names" id="family_names"
                                   ...
                                   <?php if (isset($patient)): ?>
                                       value="<?= htmlspecialchars($patient->getFamilyNames()) ?>"
                                   <?php endif; ?>
                                   placeholder="Juan Pérez" />
